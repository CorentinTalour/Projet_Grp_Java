...
public class UserControllerTest {
        ...
        private static final String COMPANY_ID = "2d93382f-1036-41d5-b638-8c081158a76f";
        ...
        private static final String COMPANY_ID2 = "2d93382f-1036-41d5-b638-8c081158a76r";
        ...
        void shouldSubscribeStatusCreated() throws Exception {
                ...
                Mockito.when(companyRepository.findById(COMPANY_ID)).thenReturn(Optional.of(new Company()));
                // when
                ResultActions result = this.mockMvc.perform(
                                MockMvcRequestBuilders
                                                .post(ENDPOINT)
