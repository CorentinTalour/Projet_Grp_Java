...
public class BookingRequest {
    ...
    @Schema(description = "Identifiant de l'hôtel associé à la réservation", example = "456e7890-e89b-12d3-a456-426614174000 (Non nullable)")
    private String hotel_id;

    @Schema(description = "Identifiant du vol associé à la réservation", example = "789e1234-e89b-12d3-a456-426614174000 (Non nullable)")
    private String plane_id;

    @Schema(description = "Identifiant de la voiture associée à la réservation", example = "321e4567-e89b-12d3-a456-426614174000 (Non nullable)")
